...
def write_anima_toml(out_path, base_dir, project_name, dit_file, vae_file, qwen_file,
    ...
    # warm-start: continue from a prior run's epoch export instead of the base DiT
    transformer = init_from if init_from else f"{models}/{dit_file}"
